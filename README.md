...
| @kudoengineer/toast      |  Modern Angular toast notification library with standalone architecture, Signals and tree-shakable
design.    | NPM Library       |
...
HTTP interceptor integration.
    | NPM Library       |
| @kudoengineer/permission      | Angular permission and role-based access control library for implementing authorization at the
UI/application layer.    | NPM Library       |
